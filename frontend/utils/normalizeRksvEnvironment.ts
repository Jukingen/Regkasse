import type { RksvEnvironmentStatusDto } from '../services/api/rksvEnvironmentTypes';
...
export function normalizeRksvEnvironmentStatus(raw: unknown): RksvEnvironmentStatusDto | null {
