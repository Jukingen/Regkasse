...
// -------------------------
// SHADOWS (refined, low clutter) — web uses boxShadow (RNW deprecates shadow*)
// -------------------------
export const SoftShadows = {
  sm: createShadowStyle('#3D3229', { width: 0, height: 1 }, 0.03, 4, 1),
  md: createShadowStyle('#3D3229', { width: 0, height: 2 }, 0.05, 8, 3),
  lg: createShadowStyle('#3D3229', { width: 0, height: 4 }, 0.06, 16, 6),
};
