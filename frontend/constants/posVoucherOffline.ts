...
export function posOfflineBlocksVoucherByMethod(isOnline: boolean, paymentMethod: string | null | undefined): boolean {
  return !isOnline && paymentMethod === 'voucher';
}

/** Split-amount POS entry: any voucher share needs connectivity. */
export function posOfflineBlocksVoucherSplitEntry(isOnline: boolean, voucherAmountEntered: number): boolean {
