...
function resolveVoucherErrorMessage(
  ...
  if (code === 'REDEEMED' || code === 'NO_BALANCE') return t('checkout:posFlow.payment.voucher.redeemed');
      ...
      <View style={styles.container}>
        ...
        {Platform.OS === 'web' ? (
          ...
          <CameraView
            ...
            onBarcodeScanned={visible && scanning && !validating ? handleBarCodeScanned : undefined}
          >
