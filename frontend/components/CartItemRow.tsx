...
export const CartItemRow: React.FC<CartItemRowProps> = ({
  ...
  const taxRate = item.taxRate || 0.2;
                  ...
                  <View key={m.id} style={styles.modifierRow}>
                    ...
                    {canChange && (
                      <View style={styles.modifierQtyGroup}>
                        <Pressable
                          onPress={() =>
                            modQty <= 1 ? onRemoveModifier?.(m) : onDecrementModifier?.(m.id)
                          }
                          style={(state) => [
                          ...
                          accessibilityLabel={
                            modQty <= 1
                              ? t('cart:itemRow.removeModifierA11y', { name: m.name })
                              : t('cart:itemRow.decreaseModifierA11y', { name: m.name })
                          }
                        ...
                        <Pressable
                          ...
                          hitSlop={{ top: 11, bottom: 11, left: 11, right: 11 }}
                          accessibilityLabel={t('cart:itemRow.increaseModifierA11y', {
                            name: m.name,
                          })}
                          accessibilityRole="button">
                          <Text style={styles.modifierQtyBtnText}>+</Text>
      ...
      <View style={styles.detailsRow}>
        ...
        <View style={styles.qtyContainer}>
          ...
          <Pressable
            ...
            accessibilityRole="button">
            <Text
              style={[styles.qtyBtnText, (!onIncrease || updating) && styles.qtyBtnTextDisabled]}>
              +
            </Text>
          </Pressable>
        </View>
