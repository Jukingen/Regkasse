...
const WaiterShortcuts: React.FC<WaiterShortcutsProps> = ({ totalAmount, onQuickAction }) => {
  const shortcuts = [
    {
      key: 'full_cash',
      label: 'Tam Nakit',
      ...
      color: '#27ae60',
      action: () => {
        onQuickAction('full_cash', totalAmount);
      },
    },
    {
      key: 'full_card',
      ...
      color: '#1976d2',
      action: () => {
        onQuickAction('full_card', totalAmount);
      },
    },
    {
      key: 'split_half',
      ...
      color: '#f39c12',
      action: () => {
        onQuickAction('split_half', totalAmount / 2);
      },
    },
    {
      key: 'add_tip_10',
      ...
      color: '#9b59b6',
      action: () => {
        onQuickAction('add_tip', totalAmount * 0.1);
      },
    },
    {
      key: 'print_receipt',
