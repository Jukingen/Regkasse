...
export const I18N_KEYS = {
  ...
  PAYMENT: {
    ...
    // Nested CONFIRMATION / RECEIPT objects below hold field keys;
    // use STEP_TITLES for step-level string keys.
...
/**
 * Çeviri anahtarlarını kullanarak çeviri yapar (hook-free).
