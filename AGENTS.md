...
- **Country / VAT / e-invoicing work** → `docs/COUNTRIES.md` + `docs/FISCAL_GERMANY.md` + `docs/FISCAL_SWITZERLAND.md` + `docs/EINVOICING_EU.md` + `docs/COUNTRY_LAYER_CUTOVER.md`. Remaining gaps (NOT STARTED): Paket 20/21/22 / 30-d in `docs/COUNTRIES.md` §16
