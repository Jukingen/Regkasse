...
namespace KasseAPI_Final.DTOs
{
    ...
    {
        public string Algorithm { get; set; } = "ES256"; // e.g., "ES256"
        public string Value { get; set; } = string.Empty; // Base64 signature
        public string SerialNumber { get; set; } = string.Empty; // Certificate Serial
        public string Timestamp { get; set; } = string.Empty; // ISO or specific format
        public string QrData { get; set; } = string.Empty; // Payload for QR code
    }
}
