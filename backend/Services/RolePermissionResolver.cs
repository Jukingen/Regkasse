...
/// <summary>
/// Resolves permissions: system roles from RolePermissionMatrix only; custom roles from AspNetRoleClaims.
/// System role claims are not applied (immutable governance).
/// </summary>
