...
/// Role resolution: Identity roles + legacy user.Role fallback. Administrator maps to Admin permission set via RolePermissionMatrix.
/// </summary>
public interface ITokenClaimsService
{
    ...
    /// Uses RoleCanonicalization for role and RolePermissionMatrix for permissions.
    /// </summary>
