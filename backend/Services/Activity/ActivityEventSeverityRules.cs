...
internal static class ActivityEventSeverityRules
{
    public static string DefaultFor(ActivityEventType type) =>
        type switch
        {
            ...
            ActivityEventType.DepExportOverdue => ActivitySeverityNames.Error,
            ActivityEventType.DepExportValidationFailed => ActivitySeverityNames.Error,
            ActivityEventType.CanaryTenantErrors => ActivitySeverityNames.Error,
            ActivityEventType.CanaryTenantHighErrorRate => ActivitySeverityNames.Error,
            ...
            ActivityEventType.SignaturkarteProgramReminder => ActivitySeverityNames.Warning,
            ActivityEventType.SignaturkarteProgramOverdue => ActivitySeverityNames.Critical,
            ActivityEventType.TseAusfallEnqueueSuggested => ActivitySeverityNames.Warning,
            ActivityEventType.TseAusfallReported => ActivitySeverityNames.Critical,
            ActivityEventType.TseWiederinbetriebnahmeReported => ActivitySeverityNames.Warning,
