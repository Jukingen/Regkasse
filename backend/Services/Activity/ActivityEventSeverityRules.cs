...
internal static class ActivityEventSeverityRules
{
    public static string DefaultFor(ActivityEventType type) =>
        type switch
        {
            ...
            ActivityEventType.DailyClosingAutoCreated => ActivitySeverityNames.Warning,
            ActivityEventType.DailyClosingOpenOrdersWarning => ActivitySeverityNames.Warning,
            ActivityEventType.MonatsbelegMissingReminder => ActivitySeverityNames.Warning,
            ...
            ActivityEventType.TrialStarted => ActivitySeverityNames.Info,
            ActivityEventType.TrialExpiringSoon => ActivitySeverityNames.Warning,
            ActivityEventType.TrialExpired => ActivitySeverityNames.Warning,
            ActivityEventType.TrialConverted => ActivitySeverityNames.Info,
            ActivityEventType.TrialDeleted => ActivitySeverityNames.Warning,
            ActivityEventType.TrialExtended => ActivitySeverityNames.Info,
            ActivityEventType.SupportTicketCreated => ActivitySeverityNames.Info,
            ActivityEventType.SupportTicketStaffReplied => ActivitySeverityNames.Info,
            ActivityEventType.SupportTicketTenantReplied => ActivitySeverityNames.Info,
            ActivityEventType.SupportTicketResolved => ActivitySeverityNames.Info,
            ActivityEventType.SupportTicketClosed => ActivitySeverityNames.Info,
            ...
            ActivityEventType.CashRegisterOpenRequested => ActivitySeverityNames.Warning,
            ActivityEventType.CashRegisterOpenRequestApproved => ActivitySeverityNames.Info,
            ActivityEventType.CashRegisterOpenRequestDenied => ActivitySeverityNames.Info,
