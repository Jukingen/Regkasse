...
public static class PermissionCatalogMetadata
{
    ...
    private static string? GetDescription(string key)
    {
        return key switch
        {
            ...
            AppPermissions.FiskalyOperationsView => "Fiskaly-Operationen anzeigen",
            AppPermissions.FiskalyOperationsNormal => "Fiskaly Normalbeleg (TEST) erzeugen",
            AppPermissions.FiskalyOperationsCancel => "Fiskaly Storno (CANCELLATION) erzeugen",
            AppPermissions.FiskalyOperationsNullbeleg => "Fiskaly Nullbeleg erzeugen",
            AppPermissions.FiskalyOperationsStartbeleg => "Fiskaly Startbeleg erzeugen",
            AppPermissions.FiskalyOperationsMonatsbeleg => "Fiskaly Monatsbeleg erzeugen",
            AppPermissions.FiskalyOperationsJahresbeleg => "Fiskaly Jahresbeleg erzeugen",
            AppPermissions.FiskalyOperationsSchlussbeleg => "Fiskaly Schlussbeleg erzeugen",
            AppPermissions.FiskalyOperationsTagesabschluss => "Fiskaly Tagesabschluss senden",
            AppPermissions.FiskalyOperationsDepExport => "DEP-Export aus Fiskaly-Operationen öffnen",
            AppPermissions.FiskalyOperationsConfig => "TSE/Fiskaly FON/SCU/Kasse initialisieren (Super-Admin)",
            AppPermissions.FiskalyHistoryView => "Fiskaly-Operationshistorie anzeigen",
            AppPermissions.FiskalyHistoryRetry => "Fehlgeschlagene Fiskaly-Operationen erneut versuchen",
