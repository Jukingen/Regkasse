# Screenshot assets (Frontend Admin)

Place captured screenshots here for documentation cross-links. Suggested filenames:
...
| `fa-deployment-license.png` | `/admin/license` — On-Premise / server license page |

Capture at 1280×720 or wider, German UI locale (`de`), Development with sample tenants if needed.
