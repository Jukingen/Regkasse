...
export interface AuthorizedQueryOptions<
  TQueryFnData = unknown,
  TError = Error,
  TData = TQueryFnData,
>
  extends Omit<UseQueryOptions<TQueryFnData, TError, TData>, 'enabled'>, AuthorizationGateOptions {
  enabled?: boolean;
}

export type AuthorizedQueryResult<TData = unknown, TError = Error> = UseQueryResult<
  TData,
  TError
> & {
...
export function useAuthorizationGate(options: AuthorizationGateOptions = {}): {
  isAuthorized: boolean;
} {
