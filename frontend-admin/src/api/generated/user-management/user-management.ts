...
export const postApiUserManagementRolesRoleNamePermissionsSimulate = (
    roleName: string,
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      headers: {'Content-Type': 'application/json', },
      data: rolePermissionSimulateRequest
    },
      options);
    }
...
export const getPostApiUserManagementRolesRoleNamePermissionsSimulateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiUserManagementRolesRoleNamePermissionsSimulate>>, TError,{roleName: string;data: RolePermissionSimulateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiUserManagementRolesRoleNamePermissionsSimulateMutationResult = NonNullable<Awaited<ReturnType<typeof postApiUserManagementRolesRoleNamePermissionsSimulate>>>
    export type PostApiUserManagementRolesRoleNamePermissionsSimulateMutationBody = RolePermissionSimulateRequest
    export type PostApiUserManagementRolesRoleNamePermissionsSimulateMutationError = unknown

    export const usePostApiUserManagementRolesRoleNamePermissionsSimulate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiUserManagementRolesRoleNamePermissionsSimulate>>, TError,{roleName: string;data: RolePermissionSimulateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationResult<
        Awaited<ReturnType<typeof postApiUserManagementRolesRoleNamePermissionsSimulate>>,
        TError,
        {roleName: string;data: RolePermissionSimulateRequest},
        TContext
      > => {

      const mutationOptions = getPostApiUserManagementRolesRoleNamePermissionsSimulateMutationOptions(options);
