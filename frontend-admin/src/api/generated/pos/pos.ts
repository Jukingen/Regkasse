...
export type GetApiPosMaintenanceStatusQueryResult = NonNullable<Awaited<ReturnType<typeof getApiPosMaintenanceStatus>>>
export type GetApiPosMaintenanceStatusQueryError = unknown

export const useGetApiPosMaintenanceStatus = <TData = Awaited<ReturnType<typeof getApiPosMaintenanceStatus>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPosMaintenanceStatus>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetApiPosMaintenanceStatusQueryOptions(options)
...
export type GetApiPosCashRegisterCurrentQueryResult = NonNullable<Awaited<ReturnType<typeof getApiPosCashRegisterCurrent>>>
export type GetApiPosCashRegisterCurrentQueryError = ProblemDetails

export const useGetApiPosCashRegisterCurrent = <TData = Awaited<ReturnType<typeof getApiPosCashRegisterCurrent>>, TError = ProblemDetails>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPosCashRegisterCurrent>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetApiPosCashRegisterCurrentQueryOptions(options)
...
export type GetApiPosMaintenanceNotificationsActiveQueryResult = NonNullable<Awaited<ReturnType<typeof getApiPosMaintenanceNotificationsActive>>>
export type GetApiPosMaintenanceNotificationsActiveQueryError = unknown

export const useGetApiPosMaintenanceNotificationsActive = <TData = Awaited<ReturnType<typeof getApiPosMaintenanceNotificationsActive>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiPosMaintenanceNotificationsActive>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetApiPosMaintenanceNotificationsActiveQueryOptions(options)
...
export const postApiPosMaintenanceNotificationsIdAcknowledge = (
    id: string,
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      headers: {'Content-Type': 'application/json', },
      data: acknowledgeMaintenanceNotificationRequestDto
    },
      options);
    }
...
export const getPostApiPosMaintenanceNotificationsIdAcknowledgeMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiPosMaintenanceNotificationsIdAcknowledge>>, TError,{id: string;data: AcknowledgeMaintenanceNotificationRequestDto}, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiPosMaintenanceNotificationsIdAcknowledgeMutationResult = NonNullable<Awaited<ReturnType<typeof postApiPosMaintenanceNotificationsIdAcknowledge>>>
    export type PostApiPosMaintenanceNotificationsIdAcknowledgeMutationBody = AcknowledgeMaintenanceNotificationRequestDto
    export type PostApiPosMaintenanceNotificationsIdAcknowledgeMutationError = ProblemDetails

    export const usePostApiPosMaintenanceNotificationsIdAcknowledge = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiPosMaintenanceNotificationsIdAcknowledge>>, TError,{id: string;data: AcknowledgeMaintenanceNotificationRequestDto}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationResult<
        Awaited<ReturnType<typeof postApiPosMaintenanceNotificationsIdAcknowledge>>,
        TError,
        {id: string;data: AcknowledgeMaintenanceNotificationRequestDto},
        TContext
      > => {

      const mutationOptions = getPostApiPosMaintenanceNotificationsIdAcknowledgeMutationOptions(options);
...
const {mutation: mutationOptions, request: requestOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiPosShiftAutoOpen>>, TError,{data: AutoOpenShiftRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
      ...
      const mutationOptions = getPostApiPosShiftAutoOpenMutationOptions(options);
...
export const getPostApiPosShiftAutoCloseMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiPosShiftAutoClose>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiPosShiftAutoClose>>, TError,void, TContext>, request?: SecondParameter<typeof customInstance>}
        ...
        Awaited<ReturnType<typeof postApiPosShiftAutoClose>>,
        TError,
        void,
        TContext
      > => {

      const mutationOptions = getPostApiPosShiftAutoCloseMutationOptions(options);
