...
import { Button, Card, Form, InputNumber, Select, Switch, Typography } from 'antd';
...
} from '@/features/settings/hooks/useSessionSettings';
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        ...
        >
          <InputNumber
            ...
            max={10}
            style={{ width: 128 }}
            addonAfter={t('settings.session.minutesUnit')}
          />
        </Form.Item>
