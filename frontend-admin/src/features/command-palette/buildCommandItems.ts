...
import {
  type DefaultCommandsContext,
  buildDefaultCommands,
} from '@/features/command-palette/defaultCommands';
...
function catalogPageItem(ctx: DefaultCommandsContext, def: SidebarNavCatalogItem): CommandItem {
