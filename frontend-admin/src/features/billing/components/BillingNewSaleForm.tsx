...
export function BillingNewSaleForm({ initialTenantId }: { initialTenantId?: string } = {}) {
  ...
  const tenantLicenseQuery = billingApi.useTenantLicense(selectedTenantId ?? '', {
    query: {
      ...
      queryKey: selectedTenantId ? billingQueryKeys.tenantLicense(selectedTenantId) : undefined,
    },
  });
            ...
            >
              ...
              {isCustomPlan ? (
                <Form.Item
                  ...
                  rules={[{ required: true, message: t('billing.new.customEndDateRequired') }]}
                >
                  <DatePicker
                    style={{ width: '100%' }}
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    ...
                    rules={[{ required: true, message: t('billing.new.priceNetRequired') }]}
                  >
                    <InputNumber min={0.01} max={999999.99} step={0.01} style={{ width: '100%' }} />
                  </Form.Item>
                </Col>
                <Col span={12}>
              ...
              <Form.Item>
                <Space wrap>
                  ...
                  <Button
                    ...
                    disabled={!preview}
                    style={
                      preview ? { backgroundColor: '#16a34a', borderColor: '#16a34a' } : undefined
                    }
                  >
            ...
            {previewMutation.isPending ? (
              ...
              <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                ...
                <Descriptions column={1} size="small" bordered>
                  ...
                  <Descriptions.Item label={t('billing.new.vat', { rate: preview.vatRate ?? 0 })}>
