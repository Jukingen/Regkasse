...
function renderTable(props: Partial<React.ComponentProps<typeof CashRegisterTable>> = {}) {
...
describe('CashRegisterTable permissions', () => {
  ...
  it('shows details and shift actions for Manager with cash_register.manage', () => {
    mockUsePermissions.mockReturnValue({
      isSuperAdmin: false,
      hasPermission: (permission: string) => permission === AppPermissions.CashRegisterManage,
    });
