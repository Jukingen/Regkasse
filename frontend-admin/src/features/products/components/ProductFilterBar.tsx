...
const STOCK_STATUS_OPTIONS: ProductStockFilterType[] = [
  'InStock',
  'OutOfStock',
  'LowStock',
  'Overstock',
...
function statusToCheckboxes(status: ProductListActiveFilter | undefined): {
  active: boolean;
  inactive: boolean;
} {
...
export function ProductFilterBar({
  ...
  const showFilteredHint =
    filteredResultCount != null && !countsLoading && filteredResultCount !== currentStatusTotal;
          ...
          <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid #f0f0f0' }}>
            <Space wrap size={[8, 8]}>
              ...
              (filters.maxPrice != null && Number.isFinite(filters.maxPrice)) ? (
                <Tag
                  closable
                  onClose={() => patchFilters({ minPrice: undefined, maxPrice: undefined })}
                >
        ...
        <Space orientation="vertical" size="large" style={{ width: '100%' }}>
          ...
          <div>
            <div style={{ marginBottom: 8, fontWeight: 500 }}>
              {t('products.filters.statusSection')}
            </div>
            <Space>
              <Checkbox
          ...
          <div>
            <div style={{ marginBottom: 8, fontWeight: 500 }}>
              {t('products.filters.createdRange')}
            </div>
            <RangePicker
              style={{ width: '100%' }}
              format="DD.MM.YYYY"
              ...
              onChange={(range) =>
                handleFilterChange('createdRange', range?.[0] && range[1] ? range : null)
              }
            />
          </div>
        </Space>
