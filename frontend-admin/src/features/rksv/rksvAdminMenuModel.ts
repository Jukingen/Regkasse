 ...
 */
export function getRksvOpenSubgroupKeys(
  pathname: string | null | undefined,
  groups: RksvMenuGroup[]
): string[] {
 ...
 */
export function buildRksvMenuGroups(
  t: (key: string) => string,
  ...
  return [
    ...
    },
    {
      ...
      items: [
        { key: '/rksv/incident', href: '/rksv/incident', label: t('nav.rksvLeafIncident') },
        {
          ...
          label: t('nav.rksvLeafReplayBatch'),
        },
        {
    ...
    },
    {
      ...
      hubTaskLine:
        'Support und Integrität: Export-Risiko, DB-weite Checks und Offline-Abdeckung prüfen.',
      items: [
        {
    ...
    },
    {
      ...
      items: [
        {
          key: '/rksv/cmc-certificate',
          href: '/rksv/cmc-certificate',
          label: t('nav.rksvLeafCmcCertificate'),
        },
        {
