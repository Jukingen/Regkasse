...
export function RksvReminderWidget() {
  ...
  useEffect(() => {
    ...
    if (
      selectedRegisterId &&
      missingMonths.some((entry) => entry.cashRegisterId === selectedRegisterId)
    ) {
      return;
    }
    ...
    return (
      ...
      >
        <Typography.Text type="secondary">
          {t('dashboard.rksvReminder.loading_monatsbeleg')}
        </Typography.Text>
      </Card>
    );
  }
            ...
            <Space wrap>
              ...
              <Select
                ...
                options={missingMonths.map((entry) => ({
                  ...
                  label: registerLabel(
                    registerById.get(entry.cashRegisterId),
                    entry.cashRegisterId
                  ),
                }))}
              />
            </Space>
