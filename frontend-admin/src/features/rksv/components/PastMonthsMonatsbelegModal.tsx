      ...
      >
        <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
          <Typography.Paragraph type="secondary" style={{ marginBottom: 0 }}>
            Fehlende Monatsbelege aus vergangenen Kalendermonaten können mit Bestätigung erstellt
            werden. FinanzOnline akzeptiert Nachreichungen in der Regel, bei längeren Lücken kann
