...
function adapterBadgeStatus(kind: string | null | undefined): 'success' | 'warning' | 'default' {
...
export function BackupConfigurationHealthCard({
  ...
  const externalArchiveConfigured = artifactPipelinePolicy?.externalArchiveRootConfigured === true;
  ...
  return (
    ...
    >
      ...
      {canManage ? (
        <Link
          href={BACKUP_SCHEDULE_SETTINGS_HREF}
