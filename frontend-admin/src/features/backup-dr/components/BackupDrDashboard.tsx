...
export function BackupDrDashboard({
  ...
  const [manualRestoreRun, setManualRestoreRun] = React.useState<BackupRunResponseDto | null>(null);
  const [manualRestoreApprovalId, setManualRestoreApprovalId] = React.useState<string | null>(null);
  ...
  const showPipelineOperatorValidityStrip =
    ...
    !(
      ...
      operatorTruth.operatorValidity.titleKey === 'backupDr.operatorValidity.stubDataPlaneTitle'
    );
  ...
  const partialSupportingQueryFailure =
    ...
    !statusQuery.isError &&
    (recoverabilityQuery.isError || verificationQuery.isError || restoreLatestQuery.isError);
          ...
          <Space orientation="vertical" size="small" style={{ width: '100%' }}>
            ...
            {error && (
              <Alert
                ...
                action={
                  <Button onClick={() => invalidateAll()}>{t('backupDr.actions.refresh')}</Button>
                }
              />
            )}
            <Collapse
        ...
        <>
          ...
          >
            <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                    ...
                    <Statistic
                      ...
                      styles={{
                        content: restoreReadinessStatisticValueStyle(
                          operatorTruth.summaryPresentation.restoreReadinessUiKind
                        ),
                      }}
                    />
                    <Typography.Paragraph
                ...
                <Col xs={24} sm={12} lg={6}>
                  <Card size="small">
                    <Statistic
                      ...
                      value={operatorTruth.summaryPresentation.configShortSummaryLine}
                    />
                    {isSimulatedAdapterEnvironment ? (
                      <Tooltip
                        title={
              ...
              <Collapse
                size="small"
                defaultActiveKey={pipelineNoticesDefaultOpen ? ['pipelineNotices'] : []}
                items={[
                  {
                    key: 'pipelineNotices',
                    ...
                    children: (
                      <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                        ...
                        {showPipelineOperatorValidityStrip && operatorTruth.operatorValidity ? (
                          <Alert
                            type={mapOperatorValidityStripToAlertType(
                              operatorTruth.operatorValidity.severity
                            )}
                            showIcon
                            title={t(operatorTruth.operatorValidity.titleKey)}
                            description={
                              <Typography.Paragraph style={{ marginBottom: 0 }}>
              ...
              >
                ...
                <ul style={{ marginBottom: 0, paddingLeft: 20 }}>
                  ...
                  <li>{t('backupDr.confidenceDashboard.nonDb.finanzOnline')}</li>
                </ul>
              </Card>
            </Space>
          </BackupDrSection>
              ...
              <Col xs={24} lg={14}>
                <BackupRunProgressBanner
                  ...
                  recoverabilityNotProven={
                    operatorTruth.progressRunBanner.recoverabilityNotProvenGlance
                  }
                ...
                {latest?.id && latest.status === BackupRunResponseDtoStatus.NUMBER_3 ? (
                  <BackupArtifactsDownloadCard
                    ...
                    simulatedOperationalMode={operatorTruth.simulatedOperationalMode}
                    loadingArtifacts={
                      (runDetailQuery.isLoading || runDetailQuery.isFetching) && Boolean(latest.id)
                    }
                    t={t}
                  />
                ) : null}
              ...
              <Col xs={24} lg={10}>
                <Card title={t('backupDr.externalCopy.title')} size="small">
                  ...
                  <Typography.Paragraph type="secondary" style={{ marginTop: 8, marginBottom: 0 }}>
                    ...
                    {t(operatorTruth.restore.backendReportedCapability.labelKey)}
                  </Typography.Paragraph>
                </Card>
              </Col>
            </Row>
          ...
          <BackupDrSection titleKey="backupDr.dashboardSections.restoreDrill" t={t}>
            <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                ...
                {!v ? (
                  ...
                  <Descriptions column={1} size="small" bordered>
                    <Descriptions.Item label={t('backupDr.table.status')}>
                      <Tag
                        color={v.status === 1 ? 'blue' : v.status === 2 ? 'error' : 'processing'}
                      >
                    ...
                    {!restoreReady ? (
                      ...
                      <>
                        ...
                        <Space wrap style={{ marginBottom: 12 }}>
                          ...
                          <Tag
                            color={
                              restoreReady.orchestratorDistributedLockEnabled ? 'blue' : 'orange'
                            }
                          >
          ...
          <BackupDrSection titleKey="backupDr.dashboardSections.configuration" t={t}>
            <Collapse
              size="small"
                                    ...
                                    <Space wrap size={[4, 8]}>
                                      {health.diagnostics.slice(0, 10).map((d, i) => (
                                        <Tooltip key={`${d.code}-${i}`} title={d.message}>
                                          <Tag color={backupDiagnosticTagColor(d.severity)}>
                                            {d.code}
                                          </Tag>
                                        </Tooltip>
                                      ))}
          ...
          <BackupDrSection titleKey="backupDr.dashboardSections.reference" t={t}>
            <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
              <Alert
                type="info"
                showIcon
          ...
          <BackupDrSection titleKey="backupDr.dashboardSections.manualActions" t={t}>
