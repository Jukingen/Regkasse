...
import { type AuditExportFormat, scheduleAuditReport } from '@/features/audit/api/auditAdmin';
...
function ScheduleReportModalContent({ open, params, onClose, onScheduled }: Props) {
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" initialValues={{ format: 'csv', schedule: '0 9 * * 1' }}>
        <Form.Item
          name="name"
