  ...
  it('computes percent from pipeline steps', () => {
    const steps: DerivedPipelineStep[] = [
      { id: 'queued', state: 'success', titleKey: 'backupDr.pipelineSteps.queued.title' },
      {
        id: 'workerRunning',
        state: 'running',
        titleKey: 'backupDr.pipelineSteps.workerRunning.title',
      },
      {
        id: 'dumpComplete',
        state: 'pending',
        titleKey: 'backupDr.pipelineSteps.dumpComplete.title',
      },
      {
        id: 'externalCopy',
        state: 'skipped',
        titleKey: 'backupDr.pipelineSteps.externalCopy.title',
      },
    ];
