...
> = {
  ...
  retention: { Icon: CloudDownloadOutlined },
  pitr: { Icon: CalendarOutlined },
  restoreHistory: { Icon: HistoryOutlined },
  restoreVerification: { Icon: CheckCircleOutlined },
...
const NAV_ID_BY_PATH: Record<string, (typeof BACKUP_SECONDARY_NAV_ITEMS)[number]['id']> = {
  ...
  [BACKUP_RETENTION_PATH]: 'retention',
  [BACKUP_PITR_PATH]: 'pitr',
  [BACKUP_RESTORE_HISTORY_PATH]: 'restoreHistory',
  [BACKUP_RESTORE_VERIFICATION_PATH]: 'restoreVerification',
