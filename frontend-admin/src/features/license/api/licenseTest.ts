...
export async function fetchLicenseTestSnapshot(tenantId?: string | null): Promise<LicenseTestSnapshot> {
...
export async function refreshLicenseTestSnapshot(tenantId?: string | null): Promise<LicenseTestSnapshot> {
