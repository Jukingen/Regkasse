...
export async function invalidateTenantLicenseQueries(
    ...
    const tasks: Array<Promise<void>> = [
        ...
        queryClient.invalidateQueries({ queryKey: licenseQueryKeys.deploymentStatus, ...INVALIDATE_ALL }),
        ...
        queryClient.invalidateQueries({ queryKey: getApiAdminTenantsQueryKey(false), ...INVALIDATE_ALL }),
        queryClient.invalidateQueries({ queryKey: getApiAdminTenantsQueryKey(true), ...INVALIDATE_ALL }),
    ];
