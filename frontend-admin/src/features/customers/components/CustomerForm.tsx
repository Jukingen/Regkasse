    ...
    >
      ...
      >
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label={t('customers.form.customerNumber')} name="customerNumber">
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item label={t('customers.form.email')} name="email" rules={[rules.email]}>
              <Input placeholder={t('customers.form.emailPlaceholder')} />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item label={t('customers.form.phone')} name="phone">
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label={t('customers.form.birthDate')} name="birthDate">
              <Input type="date" />
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row gutter={16}>
          <Col span={6}>
            <Form.Item name="isActive" valuePropName="checked" label={t('customers.form.active')}>
              <Switch />
            </Form.Item>
          </Col>
          <Col span={6}>
            <Form.Item name="isVip" valuePropName="checked" label={t('customers.form.vip')}>
              <Switch />
            </Form.Item>
          </Col>
        </Row>
