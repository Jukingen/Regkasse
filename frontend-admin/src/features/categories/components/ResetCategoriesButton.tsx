...
export function ResetCategoriesButton() {
    ...
    modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          message.success(t('common.categories.reset.success', { count: result.resetCount }));
        } catch (error) {
  ...
  return (
    <Button icon={<ReloadOutlined />} loading={resetMutation.isPending} onClick={handleReset}>
