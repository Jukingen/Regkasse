...
export function HospitalityQuickLinksCard() {
  ...
  const links: LinkDef[] = useMemo(
    () => [
      {
        href: '/reporting',
        labelKey: 'adminShell.hospitalityHub.linkReporting',
        visible: hasPermission(PERMISSIONS.REPORT_VIEW),
      },
      {
        href: '/tagesabschluss',
        labelKey: 'adminShell.hospitalityHub.linkTagesabschluss',
        visible: hasPermission(PERMISSIONS.DAILY_CLOSING_VIEW),
      },
      {
      ...
      {
        href: '/receipts',
        labelKey: 'adminShell.hospitalityHub.linkReceipts',
        visible: hasPermission(PERMISSIONS.SALE_VIEW),
      },
      {
        href: '/inventory',
      ...
      {
        href: '/pricing-rules',
        labelKey: 'adminShell.hospitalityHub.linkPricing',
        visible: hasPermission(PERMISSIONS.PRODUCT_VIEW),
      },
      {
        href: '/settings/payment-methods',
        labelKey: 'adminShell.hospitalityHub.linkPaymentsConfig',
        visible: hasPermission(PERMISSIONS.SETTINGS_VIEW),
      },
      {
        href: '/tables',
        labelKey: 'adminShell.hospitalityHub.linkTables',
        visible: hasPermission(PERMISSIONS.TABLE_VIEW),
      },
      {
        href: '/rksv/status',
        labelKey: 'adminShell.hospitalityHub.linkRksvStatus',
        visible: hasPermission(PERMISSIONS.SETTINGS_VIEW),
      },
    ],
