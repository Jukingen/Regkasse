...
import { STAFF_AREA_ROUTE_PATHS, type StaffAreaRoutePath } from '@/shared/staffAreaRoutes';

const STAFF_TAB_META: Record<StaffAreaRoutePath, { labelKey: string; Icon: ComponentType }> = {
