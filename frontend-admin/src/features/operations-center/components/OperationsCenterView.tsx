...
export default function OperationsCenterView() {
    ...
    const { data: listData, isLoading, isPlaceholderData, isError, error } = useReceiptListQuery(listParams);
        ...
        <Space orientation="vertical" size="large" style={{ width: '100%' }}>
            ...
            <Card title={t('adminShell.operationsCenter.shortcutsTitle')}>
                <Space wrap size="middle">
                    ...
                    <Link href="/dashboard">
                        <Button icon={<DashboardOutlined />}>{t('adminShell.operationsCenter.dashboardReports')}</Button>
                    </Link>
                    <Link href="/rksv">
            ...
            <Row gutter={[16, 16]}>
                ...
                <Col xs={24} lg={canSeeOpsSummary ? 12 : 24}>
                    <Card title={t('adminShell.operationsCenter.reportsQuickTitle')}>
                        ...
                        <Space wrap>
                            <Link href="/dashboard">
                                <Button type="primary">{t('adminShell.operationsCenter.openDashboardReports')}</Button>
                            </Link>
                            <Link href="/payments">
