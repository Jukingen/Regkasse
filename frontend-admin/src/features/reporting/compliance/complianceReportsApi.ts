...
export function buildTseChainExportUrl(
    detailsPath: string,
    apiBaseUrl: string,
): string {
...
export async function fetchDailyReconciliation(params: {
    ...
    const res = await AXIOS_INSTANCE.get<DailyReconciliationReport>(`${adminBase}/daily-reconciliation`, { params });
    return res.data;
}
...
export async function fetchTseChainContinuity(params: {
    ...
    const res = await AXIOS_INSTANCE.get<TseChainContinuityReport>(`${adminBase}/tse-continuity`, { params });
    return res.data;
}
...
export async function fetchOfflineRecovery(params: {
    ...
    const res = await AXIOS_INSTANCE.get<OfflineRecoveryReport>(`${adminBase}/offline-recovery`, { params });
    return res.data;
}
...
export async function fetchPeakHours(params: {
    ...
    const res = await AXIOS_INSTANCE.get<PeakHourHeatmapReport>(`${adminBase}/peak-hours`, { params });
...
export async function fetchProductMovement(params: {
    ...
    const res = await AXIOS_INSTANCE.get<ProductMovementReport>(`${adminBase}/product-movement`, { params });
    return res.data;
}
...
export async function fetchUserPerformance(params: {
    ...
    const res = await AXIOS_INSTANCE.get<UserPerformanceReport>(`${adminBase}/user-performance`, { params });
    return res.data;
}
