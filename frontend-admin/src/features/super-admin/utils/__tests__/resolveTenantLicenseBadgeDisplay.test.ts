...
describe('resolveTenantLicenseBadgeDisplay', () => {
  ...
  it('shows active badge for a valid paid license', () => {
    expect(resolveTenantLicenseBadgeDisplay('2026-07-20T00:00:00Z', 'REGK-KEY', t, now)).toEqual({
      label: 'Aktiv',
      color: 'green',
  ...
  it('shows lockdown badge for heavily expired licenses', () => {
    expect(resolveTenantLicenseBadgeDisplay('2026-01-15T00:00:00Z', 'REGK-KEY', t, now)).toEqual({
      label: 'Lockdown',
      color: 'red',
