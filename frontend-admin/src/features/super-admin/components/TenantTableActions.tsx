...
export function TenantTableActions({
  ...
  const moreItems: MenuProps['items'] = [
    ...
    },
    {
      ...
      icon: <TeamOutlined />,
      label: (
        <Link href={buildAdminUsersPageHref(tenant.id)}>{t('tenants.actions.manageUsers')}</Link>
      ),
    },
    {
      key: 'license',
    ...
    },
    {
      ...
      icon: <GlobalOutlined />,
      label: (
        <Link href={`/tenant/${tenant.id}/digital`}>{t('tenants.digitalServices.openAction')}</Link>
      ),
    },
    {
      key: 'domain',
      icon: <GlobalOutlined />,
      label: (
        <Link href={`/tenant/${tenant.id}/domain`}>{t('tenants.domainManagement.openAction')}</Link>
      ),
    },
    {
      key: 'customize',
      ...
      label: (
        <Link href={`/tenant/${tenant.id}/customize`}>{t('tenants.customization.openAction')}</Link>
      ),
    },
    {
      key: 'data-management',
      ...
      label: (
        <Link href={`/tenant/${tenant.id}/data-management`}>{t('dataManagement.openAction')}</Link>
      ),
    },
    { type: 'divider' },
    {
