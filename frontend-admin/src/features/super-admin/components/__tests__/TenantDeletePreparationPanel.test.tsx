...
function renderPanel(overrides: Partial<React.ComponentProps<typeof TenantDeletePreparationPanel>> = {}) {
...
describe('TenantDeletePreparationPanel', () => {
    ...
    it('Scenario 3: fiscal footprint shows compliance alert and payment compliance badge', async () => {
        ...
        await waitFor(() =>
            expect(screen.getByText(/Löschen nicht möglich/i)).toBeInTheDocument(),
        );
