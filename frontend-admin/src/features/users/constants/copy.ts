...
export const usersCopy = {
  ...
  activity: 'Aktivität',
  activityReport: 'Compliance-Bericht',
  activityReportFor: 'Bericht für',
  activityReportIdentity: 'Identität',
  activityReportTotalLogins: 'Anmeldungen (gesamt)',
  activityReportFailedLogins: 'Fehlgeschlagene Anmeldungen',
  activityReportActiveSessions: 'Aktive Sitzungen',
  activityReportAvgSessionMin: 'Ø Sitzungsdauer',
  activityReportLastSessionEnd: 'Letztes Sitzungsende',
  activityReportActionSummary: 'Aktionsübersicht',
  activityReportUserCreates: 'Benutzer angelegt',
  activityReportUserEdits: 'Benutzer bearbeitet',
  activityReportPayments: 'Zahlungen',
  activityReportStornos: 'Stornos',
  activityReportRefunds: 'Erstattungen',
  activityReportExports: 'Exporte',
  activityReportTimeline: 'Aktivitätsverlauf',
  activityEntityType: 'Entität',
  openFullActivityReport: 'Vollständigen Bericht öffnen',
  filterRole: 'Rolle',
  filterStatus: 'Status',
