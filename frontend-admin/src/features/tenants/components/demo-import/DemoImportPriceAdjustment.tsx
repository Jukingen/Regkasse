    ...
    return (
        ...
        >
                    ...
                    <Radio value="increasePercent">
                        <Space wrap align="center">
                            ...
                            <InputNumber
                                ...
                                onChange={(v) =>
                                    onChange({ ...value, percent: typeof v === 'number' ? v : 0 })
                                }
                                addonAfter="%"
                                style={{ width: 100 }}
                            />
                            ...
                            <Button
                                size="small"
                                type={value.mode === 'increasePercent' && value.percent === 10 ? 'primary' : 'default'}
                                onClick={(e) => {
                                    e.stopPropagation();
                                    onChange({
                                        ...DEFAULT_PRICE_ADJUSTMENT,
            ...
            <Text type="secondary" style={{ display: 'block', marginTop: 12, fontSize: 12 }}>
                ...
                {active ? 'werden mit angepassten Preisen importiert' : 'werden mit Katalogpreisen importiert'}
            </Text>
        </div>
    );
}
