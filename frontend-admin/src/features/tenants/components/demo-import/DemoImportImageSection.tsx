...
import { DEFAULT_DEMO_IMPORT_IMAGE_MODE, type DemoImportImageMode } from './demoImportImage';
    ...
    >
      ...
      {value === DEFAULT_DEMO_IMPORT_IMAGE_MODE ? (
        <Text type="secondary" style={{ display: 'block', marginTop: 10, fontSize: 12 }}>
          Bilder werden lokal erzeugt (kein Unsplash/API-Key nötig) und wie Admin-Uploads
          gespeichert.
        </Text>
      ) : null}
    </div>
