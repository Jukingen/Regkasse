...
import { Button, Dropdown, InputNumber, type MenuProps, Space, Typography } from 'antd';
import { useMemo, useState } from 'react';

import { type CatalogProduct, formatTaxRateLabel, taxRatesInProducts } from './utils';
...
export function DemoImportBulkMenu({
  products,
  onSetProductIds,
  size = 'small',
}: DemoImportBulkMenuProps) {
