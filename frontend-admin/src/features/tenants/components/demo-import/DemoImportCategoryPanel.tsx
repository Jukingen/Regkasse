...
import { applyPriceAdjustment, categoryAvatarColor, categoryAvatarLabel } from './demoImportImage';
import { type DemoImportPriceAdjustmentState, isPriceAdjustmentActive } from './priceAdjustment';
import {
  type CatalogProduct,
  PRODUCTS_PAGE_SIZE,
...
export function DemoImportCategoryPanel({
  ...
  const showAdjustedPrices = priceAdjustment != null && isPriceAdjustmentActive(priceAdjustment);
          ...
          {visibleProducts.map((product, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {showPlaceholderPreview ? categoryAvatarLabel(product.category) : group.icon}
                </Avatar>
