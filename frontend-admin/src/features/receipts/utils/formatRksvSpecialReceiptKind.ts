...
export function formatRksvSpecialReceiptKindDisplay(
  t: ReceiptTranslateFn,
  ...
  return t(
    `receipts.specialKind.${n.toLowerCase() as 'nullbeleg' | 'startbeleg' | 'monatsbeleg' | 'jahresbeleg' | 'schlussbeleg'}`
  );
}
