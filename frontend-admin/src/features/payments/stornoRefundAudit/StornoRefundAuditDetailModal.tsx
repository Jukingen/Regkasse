...
function formatDurationSeconds(
    ...
    if (secs > 0 || parts.length === 0) parts.push(t('payments.stornoRefundAudit.detail.durationSeconds', { count: secs }));
    return parts.join(' ');
}
...
export function StornoRefundAuditDetailModal({ paymentId, open, onClose }: StornoRefundAuditDetailModalProps) {
        ...
        >
            {isLoading ? (
                ...
                <>
                    ...
                    <Typography.Title level={5}>{t('payments.stornoRefundAudit.detail.sectionOriginal')}</Typography.Title>
                    <Descriptions size="small" column={2} style={{ marginBottom: 8 }}>
                        ...
                        <Descriptions.Item label={t('payments.stornoRefundAudit.detail.labelOriginalWhen')}>
                            {audit?.originalCreatedAtUtc ? fmt.formatDateTime(audit.originalCreatedAtUtc) : FORMAT_EMPTY_DISPLAY}
                        </Descriptions.Item>
                        <Descriptions.Item label={t('payments.stornoRefundAudit.detail.labelOriginalTotal')}>
                            {audit?.originalTotalAmount != null ? fmt.formatCurrency(audit.originalTotalAmount) : FORMAT_EMPTY_DISPLAY}
                        </Descriptions.Item>
                    </Descriptions>
                    <Table
                        size="small"
                    ...
                    <Typography.Title level={5}>{t('payments.stornoRefundAudit.detail.sectionReversal')}</Typography.Title>
                    <Table
                        size="small"
                        pagination={false}
                        rowKey={(_, i) => `r-${i}`}
                    ...
                    <Typography.Title level={5}>{t('payments.stornoRefundAudit.detail.sectionAuditTrail')}</Typography.Title>
