        ...
        <Space wrap style={{ width: '100%', justifyContent: 'space-between' }}>
          <Space wrap>
            <RangePicker
              ...
              placeholder={[t('payments.filtersBar.dateStart'), t('payments.filtersBar.dateEnd')]}
              onChange={(dates) =>
                handleFilterChange(
                  'dateRange',
        ...
        <Space orientation="vertical" size="large" style={{ width: '100%' }}>
          <div>
            <div style={{ fontWeight: 500, marginBottom: 8 }}>
              {t('payments.filtersBar.amountSection')}
            </div>
            <Row gutter={16}>
              <Col span={12}>
                <InputNumber
                  ...
                  onChange={(v) =>
                    handleFilterChange('minAmount', typeof v === 'number' ? v : undefined)
                  }
                />
              </Col>
              <Col span={12}>
                <InputNumber
                  ...
                  onChange={(v) =>
                    handleFilterChange('maxAmount', typeof v === 'number' ? v : undefined)
                  }
                />
              </Col>
            </Row>
          ...
          <div>
            <div style={{ fontWeight: 500, marginBottom: 8 }}>
              {t('payments.filtersBar.registerSection')}
            </div>
          ...
          <div>
            <div style={{ fontWeight: 500, marginBottom: 8 }}>
              {t('payments.filtersBar.customerSection')}
            </div>
          ...
          <div>
            <div style={{ fontWeight: 500, marginBottom: 8 }}>
              {t('payments.filtersBar.cashierSection')}
            </div>
            <UserFilterSelect
          ...
          <div>
            <div style={{ fontWeight: 500, marginBottom: 8 }}>
              {t('payments.filtersBar.transactionTypeSection')}
            </div>
