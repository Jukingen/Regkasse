...
export function CashRegisterQuickSwitch({ isMobile = false }: CashRegisterQuickSwitchProps) {
  ...
  const navigateToRegister = useCallback(
    (register: AdminCashRegisterListItem) => {
      ...
      router.push(
        `/kassenverwaltung?${FA_QUICK_CASH_REGISTER_QUERY_PARAM}=${encodeURIComponent(register.id)}`
      );
    },
  ...
  return (
    <div className="cash-register-quick-switch" data-testid="admin-header-cash-register-context">
