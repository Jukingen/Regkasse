...
import type { AdminPaymentListItemDto, CashRegister } from '@/api/generated/model';
...
const STORNO_REASON_QUERY_VALUES = [
  'FalscherBetrag',
  'KundeStorniert',
  'TechnischerFehler',
  'Anderes',
  ...
  const columns: ColumnsType<AdminPaymentListItemDto> = useMemo(
    () => [
      ...
      },
      {
        ...
        key: 'reason',
        render: (_, row) =>
          row.isStorno ? stornoReasonLabel(row.stornoReason) : FORMAT_EMPTY_DISPLAY,
      },
      {
  ...
  return (
    <AdminPageShell>
      ...
      <Typography.Paragraph type="secondary">
        {t('payments.stornoRefundAudit.intro')}
