    ...
    () => [
      {
        ...
        render: (v: string | undefined) =>
          formatDateTime(v, formatLocale, { dateStyle: 'short', timeStyle: 'medium' }),
      },
      {
    ...
    <>
      ...
      <Card>
        <Typography.Paragraph type="secondary">
          {t('reporting.dailyClosing.intro')}
        </Typography.Paragraph>
        {data?.snapshotDisclaimerDe ? (
          <Alert
            type="info"
            showIcon
            title={data.snapshotDisclaimerDe}
        ...
        <Space wrap align="center" style={{ marginBottom: 16 }}>
          ...
          />
          <Button icon={<DownloadOutlined />} onClick={handleExportCsv} disabled={!canExportCsv}>
