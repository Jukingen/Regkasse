...
import { FiskalyErrorDashboard } from '@/features/fiskaly/errors/FiskalyErrorDashboard';
...
export default function FiskalyErrorsPage() {
  const { t } = useI18n();
  ...
  const breadcrumbs = canConfigure
    ? buildPlatformAdminBreadcrumbs(t, 'securityTse', [
        ...
        { title: t('tseFiskaly.errors.pageTitle') },
      ])
    : [
  ...
  return (
    <div>
      ...
      />
      <Typography.Paragraph type="secondary">{t('tseFiskaly.errors.pageSubtitle')}</Typography.Paragraph>
