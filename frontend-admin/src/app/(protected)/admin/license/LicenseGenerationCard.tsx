...
export function LicenseGenerationCard({
  ...
  return <LicenseGenerationFormCard machineFingerprint={machineFingerprint} prefill={prefill} />;
}
...
function IssuedLicenseResult({
  ...
  const formattedExpiry = issued.expiryAtUtc ? formatGermanDateTime(issued.expiryAtUtc) : '—';
  ...
  return (
    <Space.Compact style={{ width: '100%' }}>
      {multiline ? (
        ...
        <Input value={value} readOnly style={{ fontFamily: 'ui-monospace, monospace' }} />
      )}
