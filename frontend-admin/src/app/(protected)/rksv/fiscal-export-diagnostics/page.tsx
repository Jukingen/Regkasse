...
export default function FiscalExportDiagnosticsPage() {
  ...
  const [pendingExportAction, setPendingExportAction] = useState<'preview' | 'download' | null>(
    null
  );
  ...
  return (
    <>
      ...
      <Alert
        ...
        showIcon
        style={{ marginBottom: 16 }}
        title={t('rksvHub.fiscalExportPage.profileHelp')}
      />

      {cashLoading ? <CardSkeleton count={1} /> : null}
          ...
          <div>
            ...
            <Typography.Paragraph type="secondary" style={{ marginTop: 8, marginBottom: 0 }}>
              ...
              {exportProfile === 'audit_handoff'
                ? t('rksvHub.fiscalExportPage.auditHandoffDesc')
                : null}
          ...
          <Space wrap>
            <div>
              <Typography.Text strong>
                {t('rksvHub.fiscalExportPage.cashRegisterLabel')}
              </Typography.Text>
              <br />
              <Select
            ...
            <div>
              <Typography.Text strong>
                {t('rksvHub.fiscalExportPage.utcRangeLabel')}
              </Typography.Text>
              <br />
              <RangePicker
            ...
            <div>
              <Typography.Text strong>
                {t('rksvHub.fiscalExportPage.includeCsvLabel')}
              </Typography.Text>
              <br />
        ...
        <>
          ...
          {preview.notLegalProofNotice != null ? (
            <Alert
              ...
              style={{ marginBottom: 16 }}
              title={
                preview.notLegalProofNotice || t('rksvHub.fiscalExportPage.notLegalProofFallback')
              }
          ...
          <Card
            size="small"
            style={{ marginBottom: 16 }}
            title={t('rksvHub.fiscalExportPage.summaryCardTitle')}
          >
            <Space wrap>
          ...
          {preview.exportScopeWarnings?.length ? (
            <Card
              size="small"
              style={{ marginBottom: 16 }}
              title={t('rksvHub.fiscalExportPage.exportScopeWarningsCardTitle')}
            >
              <List
                size="small"
          ...
          {preview.chainContinuityWarnings?.length ? (
            <Card
              size="small"
              style={{ marginBottom: 16 }}
              title={t('rksvHub.fiscalExportPage.chainContinuityWarningsCardTitle')}
            >
              <Alert
                type="warning"
                showIcon
          ...
          {preview.integrity ? (
            <Card
              size="small"
              style={{ marginBottom: 16 }}
              title={t('rksvHub.fiscalExportPage.integrityDiagnosticsCardTitle')}
            >
      ...
      {!exportLoading && !preview ? (
        <Card
          size="small"
          title={t('rksvHub.fiscalExportPage.emptyHintCardTitle')}
          style={{ marginTop: 16 }}
        >
