    ...
    <>
      ...
      {data && (
        <>
          <Card size="small" style={{ marginBottom: 16 }}>
            <Space orientation="vertical" size="small">
              <Typography.Text strong>
                {t('rksvHub.replayBatchDetail.batchOverview')}
              </Typography.Text>
              <Row gutter={[12, 12]}>
                <Col xs={24} sm={8}>
                  <Card size="small">
                    <Statistic
                      title={t('rksvHub.replayBatchDetail.statItemsTotal')}
                ...
                <Col xs={24} sm={8}>
                  <Card size="small">
                    <Statistic
                      title={t('rksvHub.replayBatchDetail.statSuccessReplay')}
              ...
              <Space wrap style={{ marginTop: 8 }}>
                ...
                {auditTraceHref ? (
                  <Button href={auditTraceHref}>{OPERATOR_LINK_LABELS.verificationsAudit}</Button>
                ) : data.correlationId ? (
          ...
          <Card
            size="small"
            title={OPERATOR_REPLAY_COPY.investigationPathTitle}
            style={{ marginBottom: 16 }}
          >
          ...
          <Card
            size="small"
            title={t('rksvHub.replayBatchDetail.observabilityCardTitle')}
            style={{ marginBottom: 16 }}
          >
            <Row gutter={[12, 12]}>
              <Col xs={24} sm={8}>
                ...
                <Card size="small">
                  <Statistic
                    ...
                    styles={{
                      content: {
                        color:
                          (data.offlineFinalFailureAuditCount ?? 0) > 0 ? '#cf1322' : undefined,
                      },
                    }}
                  />
                  <Typography.Text type="secondary" style={{ fontSize: 12 }}>
              ...
              expandable={{
                expandedRowRender: (r) => (
                  <div style={{ padding: '4px 8px 12px', background: '#fafafa' }}>
                    ...
                    <Descriptions bordered size="small" column={1} style={{ marginTop: 8 }}>
                      <Descriptions.Item
                        label={t('rksvHub.replayBatchDetail.labelBatchCorrelation')}
                      >
                        <Typography.Text code copyable>
                          {String(data.correlationId ?? '—')}
                        </Typography.Text>
                      ...
                      <Descriptions.Item
                        label={t('rksvHub.replayBatchDetail.labelAuditCorrelation')}
                      >
                        <Typography.Text code copyable>
                          {data.auditCorrelationId ?? '—'}
                        </Typography.Text>
