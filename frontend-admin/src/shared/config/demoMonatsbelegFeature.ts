import { parseStrictRksvPublicEnvironment, RksvPublicEnvironmentState } from '@/shared/config/rksvEnvironment';
...
export function isDemoAutoSuggestMonatsbelegEnabled(): boolean {
    const flagEnabled = parseDemoAutoSuggestMonatsbelegEnv(process.env.NEXT_PUBLIC_DEMO_AUTO_SUGGEST_MONATSBELEG);
