...
export function getViennaCalendarYearMonth(now: Date = new Date()): {
  year: number;
  month: number;
} {
...
export function getViennaCalendarDate(now: Date = new Date()): {
  year: number;
  month: number;
  day: number;
} {
...
export function isSameViennaCalendarDay(
