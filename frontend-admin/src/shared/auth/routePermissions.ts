...
export const ROUTE_PERMISSIONS: Record<string, string | string[]> = {
  ...
  '/admin/sessions': PERMISSIONS.USER_VIEW,
  ...
  '/backup/retention': PERMISSIONS.SETTINGS_VIEW,
  ...
  '/admin/billing/subscription-invoices': [PERMISSIONS.SYSTEM_CRITICAL],
  ...
  '/admin/tse/sla': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/capacity': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/cost': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/disaster-recovery': [PERMISSIONS.SYSTEM_CRITICAL],
  ...
  '/admin/tse/api-gateway': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/anomalies': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/analytics': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/user-analytics': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/recommendations': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/updates': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/sustainability': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/webhooks': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/blockchain': [PERMISSIONS.SYSTEM_CRITICAL],
  '/admin/tse/training': [PERMISSIONS.SYSTEM_CRITICAL],
